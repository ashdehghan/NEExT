...
class Graph_Embedding_Engine:
    ...
    def __init__(self, global_config):
        ...
        self.embedding_engines["approx_wasserstein"] = \
            self.build_approx_wasserstein_graph_embedding
        self.embedding_engines["wasserstein"] = \
            self.build_wasserstein_graph_embedding
        self.embedding_engines["sinkhornvectorizer"] = \
            self.build_sinkhornvectorizer_graph_embedding
    ...
    def build_graph_embedding(self, emb_dim_len, emb_engine, graph_c, graph_feat_cols=[]):
        if emb_engine in self.embedding_engines:
            ...
            graphs_embed, graph_embedding_df = self.embedding_engines[emb_engine](
