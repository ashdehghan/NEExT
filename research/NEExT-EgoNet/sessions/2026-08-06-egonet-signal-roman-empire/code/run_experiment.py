...
def main():
    ...
    if cfg.get("n_centers"):
        # Stratified center subsample — every method sees the SAME canonical
        # node table, so splits stay paired across representations.
        node_table = sample_centers(node_table, n_centers=cfg["n_centers"], seed=cfg["center_seed"])
