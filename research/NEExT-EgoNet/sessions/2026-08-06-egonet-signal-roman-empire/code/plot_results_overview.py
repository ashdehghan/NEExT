"""Experiment 2 overview figure (Roman Empire) — merged-axis layout.

Thin wrapper over lib.nodeclass.figures.dataset_overview_figure.
Output: figures/exp2_overview.{pdf,png}
...
stem = dataset_overview_figure(
    df,
    khop_methods={f"egonet_k{k}_wass": f"$k{{=}}{k}$" for k in [1, 2, 3, 4]},
    walk_methods={"walk_tight_wass": "tight", "walk_default_wass": "default", "walk_wide_wass": "wide"},
    stem=SESSION_ROOT / "figures" / "exp2_overview",
)
