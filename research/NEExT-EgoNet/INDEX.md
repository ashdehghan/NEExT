...
|---|---|---|---|
| [2026-08-06-egonet-signal-amazon-ratings](sessions/2026-08-06-egonet-signal-amazon-ratings/) | active | **Experiment 4:** Roman-twin test (AMAZON_RATINGS, deg 7.6, rating classes, 3000 centers) — full pattern, both scopes | Prediction mostly WRONG: ASCENDING k-profile in both scopes (first), global>=local everywhere, global k3 .400 barely tops node_struct .384; floor .30 (majority .37), field compressed — weak diffuse signal that accumulates with coverage. Feature pass 46 min, cached |
| [2026-08-06-egonet-signal-wiki-chameleon](sessions/2026-08-06-egonet-signal-wiki-chameleon/) | active | **Experiment 3:** airports-mechanism twin test (CHAMELEON, deg 27.6, traffic quintiles, 1000 stratified centers) — full pattern, both scopes, walk trio | Half-confirmed: node_struct strong (.635) BUT k-profile peaks at k2 (non-monotone, new) and global k2 .660 BEATS the node baseline (+.024) — first bag>node on a dense graph; local walk locality ordering reversed. Third regime: dense + partially neighborhood-encoded label |
| [2026-08-06-egonet-signal-roman-empire](sessions/2026-08-06-egonet-signal-roman-empire/) | active | **Experiment 2:** sparse heterophilous contrast (ROMAN_EMPIRE, deg 2.9, 18 roles) — does the k-profile invert and does the node-features ceiling drop? First pass: local k1/k2 vs permutation floor, 3000 centers | Local: k1 .306 > k2 .262 > k3 .180 > k4 .137 vs floor .10 — monotone dilution decay, no inversion. Global REVERSES airports: .228/.149/.125/.118 — loses to local everywhere (sparse graph -> global per-node features degenerate; in-bag fragment shape discriminates). Feature pass 22 min (culprit TBD), now cached to parquet. node_struct .217 — local k1 BEATS the node baseline by +.089 (k2 ties it): neighborhood > node on heterophilous labels, completing the two-dataset contrast |
| [2026-08-06-egonet-signal-airports-eu](sessions/2026-08-06-egonet-signal-airports-eu/) | active | **Experiment 1 (new research line):** signal detection — k∈{1,2,3} egonets, 4 features (vlen 1), Wass dim 4, XGBoost vs permutation floor on AIRPORTS_EUROPE | Signal YES, k-sweep: k1 .536±.024 > k2 .463 > k3 .434, all >> permuted floor .249 (no leakage); coverage 4%/70%/99% — accuracy falls monotonically with saturation, signal is local; 22 s runtime |
