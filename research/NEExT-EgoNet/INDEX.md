...
|---|---|---|---|
| [2026-08-06-egonet-signal-roman-empire](sessions/2026-08-06-egonet-signal-roman-empire/) | active | **Experiment 2:** sparse heterophilous contrast (ROMAN_EMPIRE, deg 2.9, 18 roles) — does the k-profile invert and does the node-features ceiling drop? First pass: local k1/k2 vs permutation floor, 3000 centers | k1 .306 > k2 .262 > k3 .180 > k4 .137 (~majority) vs floor .100 — monotone decay, NO inversion; k4 only 0.08% of graph so decay = pure dilution, not saturation. Signal is in the immediate neighborhood at BOTH density extremes |
