...
|---|---|---|---|
| [2026-08-06-egonet-signal-roman-empire](sessions/2026-08-06-egonet-signal-roman-empire/) | active | **Experiment 2:** sparse heterophilous contrast (ROMAN_EMPIRE, deg 2.9, 18 roles) — does the k-profile invert and does the node-features ceiling drop? First pass: local k1/k2 vs permutation floor, 3000 centers | Local: k1 .306 > k2 .262 > k3 .180 > k4 .137 vs floor .10 — monotone dilution decay, no inversion. Global REVERSES airports: .228/.149/.125/.118 — loses to local everywhere (sparse graph -> global per-node features degenerate; in-bag fragment shape discriminates). Feature pass 22 min (culprit TBD) |
