...
|---|---|---|---|
| [2026-08-06-egonet-signal-roman-empire](sessions/2026-08-06-egonet-signal-roman-empire/) | active | **Experiment 2:** sparse heterophilous contrast (ROMAN_EMPIRE, deg 2.9, 18 roles) — does the k-profile invert and does the node-features ceiling drop? First pass: local k1/k2 vs permutation floor, 3000 centers | First pass: k1 .308 > k2 .266 vs floor .100 — 3x chance, but NO inversion yet (k1 still wins with 4-node bags); macro-F1 .16 (imbalance); 79 s |
